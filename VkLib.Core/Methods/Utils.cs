...
namespace VkLib.Methods
{
    ...
    public class Utils
    {
        ...
        public async Task<VkLib.Types.Utils.LinkChecked> CheckLink(string url = null)
        {
            ...
            return await _vkontakte.GetAsync<VkLib.Types.Utils.LinkChecked>("utils.checkLink", parameters);
        }
        ...
        public async Task<VkLib.Types.Utils.DomainResolved> ResolveScreenName(string screen_name = null)
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>();
            ...
            return await _vkontakte.GetAsync<VkLib.Types.Utils.DomainResolved>("utils.resolveScreenName", parameters);
        }
